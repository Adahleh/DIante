...
$insert = mysqli_query($dbConn,"insert into packages (Type,Price) values ('$Type','$Price')");
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Add_New_Package.php" class="form-horizontal" enctype="multipart/form-data">
                                
								
								
								 <div class="form-group"><label class="col-sm-2 control-label">Type *</label>

                                    <div class="col-sm-10"><input value="" style="width:450px" type="text" name="Type" class="form-control" required></div>
                                </div>
								...
								<div class="form-group"><label class="col-sm-2 control-label">Price *</label>
                                    ...
                                    <div class="col-sm-10"><input style="width:450px" type="number" name="Price" value="" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
