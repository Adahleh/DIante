...
$insert = mysqli_query($dbConn,"insert into vehicles (Type,Price) values ('$Type','$Price')");
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Add_New_Vehicle.php" class="form-horizontal" enctype="multipart/form-data">
