...
<body style="back">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>View Vehicles List Information</h5>
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from vehicles order by ID ASC");
 ...
 <a href="Edit_Vehicle.php?V_ID=<?php echo $V_ID; ?>" style="width:52px" class="btn btn-primary btn-sm" role="button">Edit</a>
 <br>
 <a href="JavaScript:if(confirm('Are You Sure To Delete This Vehicle ?')==true)
{window.location='Delete_Vehicle.php?V_ID=<?php echo $V_ID; ?>';}" class="btn btn-primary btn-sm" role="button">Delete</a>
