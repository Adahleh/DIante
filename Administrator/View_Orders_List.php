 ...
 <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from orders order by ID DESC");
                    ...
                    <tr class="grade">
                        ...
                        <td><img src="<?php echo $Picture_File; ?>" width="75%"/></td>
                        <td><?php echo $D_Name; ?></td>
                        <td><?php echo $D_Phone_Number; ?></td>
                        <td><?php echo $End_Time; ?></td>
                        <td><?php echo $Start_Time; ?></td>
                        <td><?php echo $End_Time; ?></td>
                        <td><?php echo $Total_KM_Distance; ?></td>
                        <td><?php echo $Estimation_Time; ?></td>
                        <td><?php echo $Total_Price; ?></td>
		                <td><?php echo $Status; ?></td>
                        <td><?php echo $Add_Date_Time; ?></td>


 <td><center><a href="JavaScript:if(confirm('Are You Sure To Delete This Order ?')==true)
{window.location='Delete_Order.php?O_ID=<?php echo $O_ID; ?>';}" class="btn btn-primary btn-sm" role="button">Delete</a>
