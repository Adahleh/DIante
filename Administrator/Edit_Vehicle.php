...
$sql1 = mysqli_query($dbConn,"select * from vehicles where ID='$V_ID'");
...
$sql1 = mysqli_query($dbConn,"update vehicles set Type='$Type', Price='$Price' where ID='$V_ID'");
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Edit_Vehicle.php?V_ID=<?php echo $V_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
