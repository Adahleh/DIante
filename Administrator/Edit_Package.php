...
$sql1 = mysqli_query($dbConn,"select * from packages where ID='$P_ID'");
...
$sql1 = mysqli_query($dbConn,"update packages set Type='$Type', Price='$Price' where ID='$P_ID'");

echo "<script language='JavaScript'>
			  alert ('Package Information Has Been Updated !');
      </script>";
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Edit Package Information</h5>
                     ...
                     <form method="post" action="Edit_Package.php?P_ID=<?php echo $P_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
							...
							<input type="hidden" name="P_ID" value="<?php echo $P_ID; ?>"/>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Type *</label>
                                    ...
                                    <div class="col-sm-10"><input style="width:450px" type="text" name="Type" value="<?php echo $Type; ?>" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
								  ...
								  <div class="form-group"><label class="col-sm-2 control-label">Price *</label>
                                    ...
                                    <div class="col-sm-10"><input value="<?php echo $Price; ?>" style="width:450px" type="number" name="Price" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
