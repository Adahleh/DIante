...
<body style="back">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>View Packages List Information</h5>
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from packages order by ID ASC");
 ...
 <a href="Edit_Package.php?P_ID=<?php echo $P_ID; ?>" style="width:52px" class="btn btn-primary btn-sm" role="button">Edit</a>
 <br>
 <a href="JavaScript:if(confirm('Are You Sure To Delete This Package ?')==true)
{window.location='Delete_Package.php?P_ID=<?php echo $P_ID; ?>';}" class="btn btn-primary btn-sm" role="button">Delete</a>
