...
<body style="back">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>View Drivers List Information</h5>
                    ...
                    <tr>
                            ...
                            <th>Phone Number</th>
                            <th>Email Address</th>
                            <th>Lack Of Judgment File</th>
                            <th>Driving Licence ID</th>
                            <th>Car Licence ID</th>
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from drivers order by ID DESC");
					while ($row1 = mysqli_fetch_array($sql1)){
						...
						$Lack_Of_Judgment_File = $row1['Lack_Of_Judgment_File'];
						$Driver_licence_ID = $row1['Driver_licence_ID'];
						$Car_Licence_ID = $row1['Car_Licence_ID'];
						$Car_Plat_Number = $row1['Car_Plat_Number'];
                    ...
                    <tr class="grade">
                          ...
                          <td><img src="<?php echo $Lack_Of_Judgment_File; ?>" width="50%"/></td>
                          <td><img src="<?php echo $Driver_licence_ID; ?>" width="50%"/></td>
                          <td><img src="<?php echo $Car_Licence_ID; ?>" width="50%"/></td>
                          <td><?php echo $Car_Plat_Number; ?></td>
 ...
 <a href="Edit_Driver.php?D_ID=<?php echo $D_ID; ?>" style="width:52px" class="btn btn-primary btn-sm" role="button">Edit</a>
 <br>
 <a href="JavaScript:if(confirm('Are You Sure To Delete This Driver ?')==true)
{window.location='Delete_Driver.php?D_ID=<?php echo $D_ID; ?>';}" class="btn btn-primary btn-sm" role="button">Delete</a>
