...
$query = mysqli_query($dbConn,"SELECT * FROM drivers WHERE (Phone_Number='$Phone_Number' AND Password='$Password') AND Status='Active'"); 
...
<div class="col-lg-12">
                <div class="ibox float-e-margins">
                  ...
                  <br>
                     ...
                     <form method="post" action="Driver_Signin.php" class="form-horizontal" enctype="multipart/form-data">
     ...
     <INPUT TYPE="hidden" NAME="lat" ID="lat" VALUE="">
                  ...
                  <center>	<font style="color:#000"><a href="Driver_Forget_Password.php" style="color:#0f76ba">Forget your password?</a></font></center>
                 							<br>

                  <center>	<font style="color:#000">I dont have account? <a href="Driver_Singup.php" style="color:#0f76ba">Sign Up</a></font></center>
