...
$E_Longitude_2=$_GET['E_Longitude_2'];
$E_Latitude_2=$_GET['E_Latitude_2'];
...
$E_Longitude_2=$_POST['E_Longitude_2'];
$E_Latitude_2=$_POST['E_Latitude_2'];



$sql1 = mysqli_query($dbConn,"insert into orders (End_Longitude_2,End_Latitude_2,Location_Type,Users_Notes,Driver_ID,User_ID,Package_ID,Vehicle_ID,Picture_File,Start_Longitude,Start_Latitude,End_Longitude,End_Latitude,Date,Start_Time,End_Time,Estimation_Time,Total_KM_Distance,Total_Price,Driver_Rate_Status,Status) values ('$E_Longitude_2','$E_Latitude_2','$Location_Type','$Users_Notes','$D_ID','$U_ID','$P_ID','$V_ID','$Picture','$S_Longitude','$S_Latitude','$E_Longitude','$E_Latitude','$Date','$Start_Time','','','$TK','$T_Cost_2','','Waiting')");
...
<div class="table-responsive">
 ...
 $unit1 = 'K';											
  $theta1 = $S_Longitude - $E_Longitude_2;
 ...
 $unit2 = 'K';											
  $theta2 = $E_Longitude - $E_Longitude_2;
  $dist2 = sin(deg2rad($E_Latitude)) * sin(deg2rad($E_Latitude_2)) +  cos(deg2rad($E_Latitude)) * cos(deg2rad($E_Latitude_2)) * cos(deg2rad($theta2));

  $dist2 = acos($dist2);
  $dist2 = rad2deg($dist2);
  $miles2 = $dist2 * 60 * 1.1515;
  $unit2 = strtoupper($unit2);										
  $Distance2 = ceil($miles2 * 1.609344);	
...
$TK = $Distance1+$Distance2;
$T_Cost = ($Distance1+$Distance2) * 0.30;
...
$T_Cost_2 = $T_Cost + $T_Cost_1 + $V_Price + $P_Price + $Penlty_Balance;
      ...
      <form method="post" action="View_Drivers_2.php?Users_Notes=<?php echo $Users_Notes; ?>&Location_Type=<?php echo $Location_Type; ?>&P_ID=<?php echo $P_ID; ?>&V_ID=<?php echo $V_ID; ?>&D_ID=<?php echo $D_ID; ?>&U_ID=<?php echo $U_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
                      
					  					  <input type="hidden" name="Picture" value="<?php echo $Picture; ?>"/>
					  					  <input type="hidden" name="V_ID" value="<?php echo $V_ID; ?>"/>
					  					  <input type="hidden" name="P_ID" value="<?php echo $P_ID; ?>"/>
					  					  <input type="hidden" name="U_ID" value="<?php echo $U_ID; ?>"/>
					  					  <input type="hidden" name="T_Cost_2" value="<?php echo $T_Cost_2; ?>"/>
					  ...
					  <input type="hidden" name="S_Longitude" value="<?php echo $S_Longitude; ?>"/>
					  <input type="hidden" name="S_Latitude" value="<?php echo $S_Latitude; ?>"/>
					  <input type="hidden" name="E_Longitude" value="<?php echo $E_Longitude; ?>"/>
					  <input type="hidden" name="E_Latitude" value="<?php echo $E_Latitude; ?>"/>


					  <input type="hidden" name="E_Longitude_2" value="<?php echo $E_Longitude_2; ?>"/>
					  <input type="hidden" name="E_Latitude_2" value="<?php echo $E_Latitude_2; ?>"/>



					  <input type="hidden" name="D_Longitude" value="<?php echo $D_Longitude; ?>"/>
					  <input type="hidden" name="D_Latitude" value="<?php echo $D_Latitude; ?>"/>
					 
					  <input type="hidden" name="Location_Type" value="<?php echo $Location_Type; ?>"/>
					  <input type="hidden" name="Users_Notes" value="<?php echo $Users_Notes; ?>"/>
