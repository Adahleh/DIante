...
if (isset($_POST['Submit'])) {
    ...
    $E_Longitude = $_POST['long'];
    $E_Latitude = $_POST['lat'];

    $Picture = $_POST['Picture'];


    echo '<script language="JavaScript">
            document.location="Request_Driver_4.php?Location_Type=' . $Location_Type . '&Users_Notes=' . $Users_Notes . '&Picture=' . $Picture . '&U_ID=' . $U_ID . '&P_ID=' . $P_ID . '&V_ID=' . $V_ID . '&S_Longitude=' . $S_Longitude . '&S_Latitude=' . $S_Latitude . '&E_Longitude=' . $E_Longitude . '&E_Latitude=' . $E_Latitude . '";
      </script>';
                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <form method="post" action="Request_Driver_3.php" class="form-horizontal"
                                        ...
                                        <div class="form-group"><label class="col-sm-2 control-label">Pickoff Location
                                                One *</label>
