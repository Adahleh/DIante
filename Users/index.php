...
$O_ID = $row789['ID'];
 ...
 document.location="Track_Driver.php?O_ID='.$O_ID.'&D_ID='.$D_ID.'&S_Longitude='.$S_Longitude.'&S_Latitude='.$S_Latitude.'&E_Longitude='.$E_Longitude.'&E_Latitude='.$E_Latitude.'";
	...
	$sql123 = mysqli_query($dbConn,"select * from users where ID='$U_ID'");
	...
	$row123 = mysqli_fetch_array($sql123);
		...
		$Latitude = $row123['Latitude'];
	  	...
	  	$sql123 = mysqli_query($dbConn,"select * from orders where User_ID='$U_ID' AND (Status='Finish' AND Driver_Rate_Status='')");
		...
		echo '<script language="JavaScript">
 document.location="Rate_Driver.php?U_ID='.$U_ID.'&D_ID='.$D_ID.'&O_ID='.$O_ID.'";
</script>';	
...
function showError(error) {
  ...
  border-bottom-right-radius: 35px;
   ...
   <br>
		...
		<center><a href="Request_Driver.php" class="btn btn-danger">Request Driver</a></center>								
