...
echo '<script language="JavaScript">
            document.location="View_Drivers.php?Location_Type='.$Location_Type.'&Users_Notes='.$Users_Notes.'&Picture='.$Picture.'&U_ID='.$U_ID.'&P_ID='.$P_ID.'&V_ID='.$V_ID.'&S_Longitude='.$S_Longitude.'&S_Latitude='.$S_Latitude.'&E_Longitude='.$E_Longitude.'&E_Latitude='.$E_Latitude.'";
      </script>';
...
<div class="col-lg-12">
                <div class="ibox float-e-margins">
                  ...
                  <br>
                     ...
                     <form method="post" action="Request_Driver_2.php" class="form-horizontal" enctype="multipart/form-data">
 ...
 <input type="hidden" name="lat" id="us3-lat" required />
							     ...
							     <div class="form-group"><label class="col-sm-2 control-label">Pickoff Location *</label>
