...
$query = mysqli_query($dbConn,"SELECT * FROM drivers WHERE Phone_Number='$Phone_Number' AND ID!='$D_ID'"); 
...
$insert = mysqli_query($dbConn,"update drivers set Phone_Number='$Phone_Number', Password='$Password' where ID='$D_ID'");
