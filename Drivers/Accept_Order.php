...
$Start_Longitude = $row11['Start_Longitude'];
$Start_Latitude = $row11['Start_Latitude'];
...
if ($End_Latitude_2=='' && $End_Longitude_2==''){
	
	
	$ST = '<button class="btn btn-danger" type="submit" name="Submit">Finish Order</button>';
	
}else{
	
	
	$ST = '<button class="btn btn-danger" type="submit" name="Submit_2">View Second Location</button>';
...
if(isset($_POST['Submit_2']))
{
	...
	echo '<script language="JavaScript">
            document.location="Accept_Order_2.php?O_ID='.$O_ID.'";
        </script>';
...
function showPosition(position) {
 ...
 <form method="post" action="Accept_Order.php?O_ID=<?php echo $O_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
    ...
    <script>
      ...
      function calculateAndDisplayRoute(directionsService, directionsDisplay) {
        ...
        directionsService.route({
          origin: {lat: <?php echo $Start_Longitude; ?>, lng: <?php echo $Start_Latitude; ?>}, 
          destination: {lat: <?php echo $End_Latitude; ?>, lng: <?php echo $End_Longitude; ?>},
