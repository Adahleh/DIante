...
header("refresh: 30;");
	...
	$sql123 = mysqli_query($dbConn,"select * from drivers where ID='$D_ID'");
	
	
	$row123 = mysqli_fetch_array($sql123);
		
		
		$Longitude = $row123['Longitude'];
		$Latitude = $row123['Latitude'];
		
		
	
	

	  $sql121 = mysqli_query($dbConn,"select * from orders where Driver_ID='$D_ID' AND (Status='Waiting' OR Status='Accepted')");
if (mysqli_num_rows($sql121)>0){
	
	
	
echo '<script language="JavaScript">
 document.location="My_Orders.php";
</script>';	
...
function showError(error) {
  ...
  <body onload="showPosition();" class="canvas-menu" style="style background-image: url('../img/bg.png'); background-size: 100% 100%; background-repeat: no-repeat;">
    <div id="wrapper" >
            ...
            <div class="sidebar-collapse" style="background-color:#0f76ba"  class="animated" id="animation_box">
                ...
                <li class="nav-header" style="background-image: url('../img/logo123.png'); background-size: 50% 50%; background-repeat: no-repeat; border-radius: 20px;">
					...
					<a href="My_Account.php" title="My Account"><i class="fa fa-user"></i> <span class="nav-label">My Account</span></a>
                     ...
                     <li class="">
                         <a href="Show_m.php" title="My orders list"><i class="fa fa-user"></i> <span class="nav-label">My orders list</span></a>
                     </li>
                            ...
                            <div class="col-lg-12">
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title">
                                        <h5>Welcome To UniCar</h5>
                                       
                                    </div>
                                    
					<br>				
	<center><a href="My_Orders.php" class="btn btn-danger">My Orders</a></center>								
    
	
	
	
	
	<div id="embedMap" style="width:100%; height:540px">
