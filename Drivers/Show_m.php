...
//$sql=mysqli_query($dbConn,"select * from orders where Driver_ID='$D_ID'");
...
//}
//$sql="select * from orders where Driver_ID='$D_ID'";
                                ...
                                <div class="ibox-content">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                                            ...
                                            $sql1 = mysqli_query($dbConn,"select * from orders where Driver_ID='$D_ID' order by ID DESC");
