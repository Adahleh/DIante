...
$sql1 = mysqli_query($Conn,"update users set Password='$New_Password' where ID='$U_ID'");
...
<div class="col-lg-12">
             ...
             <br><br>
                     ...
                     <form method="post" action="User_Forget_Password.php" class="form-horizontal" enctype="multipart/form-data">
