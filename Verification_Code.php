...
if ($Code==$Verification_Code){
	...
	$query = mysqli_query($dbConn,"UPDATE users set Status='Active' where ID='$U_ID'"); 
...
<div class="col-lg-12">
             ...
             <br><br>
                     ...
                     <form method="post" action="Verification_Code.php?Verification_Code=<?php echo $Verification_Code; ?>&U_ID=<?php echo $U_ID; ?>&Phone_Number=<?php echo $Phone_Number; ?>" class="form-horizontal" enctype="multipart/form-data">
