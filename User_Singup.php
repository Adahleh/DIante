...
if (isset($_POST['Submit'])) {
    ...
    if (mysqli_num_rows($query) > 0) {
        ...
        $insert = mysqli_query($dbConn, "insert into users (Name,Phone_Number,Email_Address,Password,Status,Verification_Code,Penlty_Balance) values ('$Name','$Phone_Number','$Email_Address','$Password','Pending','$Verification_Code','0')");


        $sql11 = mysqli_query($dbConn, "select * from users where Phone_Number='$Phone_Number'");
...
// echo "response:".$response;
        ...
        echo '<script language="JavaScript">
            document.location="Verification_Code.php?Phone_Number=' . $Phone_Number . '&U_ID=' . $U_ID . '&Verification_Code=' . $Verification_Code . '";
          </script>';


        $Error = 'Thanks Alot For Signup <a href="User_Signin.php"> You Can Signin Now !</a>';
                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <form method="post" action="User_Singup.php" class="form-horizontal"
                                        ...
                                        <div class="form-group"><label class="col-sm-2 control-label">Name *</label>
                                            ...
                                            <div class="col-sm-10"><input value="" type="text" name="Name"
                                        ...
                                        <div class="form-group"><label class="col-sm-2 control-label">Email
                                            ...
                                            <div class="col-sm-10"><input value="" type="email" name="Email_Address"
                                                                          class="form-control" required></div>
                                        </div>
                                        <div class="hr-line-dashed"></div>
                                        ...
                                        <div class="form-group"><label class="col-sm-2 control-label">Phone Number
                                            ...
                                            <div class="col-sm-10"><input value="" type="text" pattern="[0-9]{10}"
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-4 col-sm-offset-2">
                                                <center>
                                                    <button class="btn btn-primary" type="submit" name="Submit">Signup
                                                    </button>
